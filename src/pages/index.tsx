                ...
                <Presentation>
                    <div className="content">
                        <div className="containerTitle ">
                            ...
                            <p>
                                Através de uma equipe multidisciplinar e
                                especialista focada em atendimento humanizado
                    ...
                    <div className="contentKeyWords limitWidth">
                        <div className="wordKeyConceptions">
                            ...
                            <p className="paragraph">
                                Somos uma entidade sem fins lucrativos, fundada
                                em 29 de outubro de 1974, que atua hoje na
                                gestão compartilhada de saúde em conjunto ao
                                Poder Público, nas esferas municipais, estaduais
                                e federais.
                            </p>
